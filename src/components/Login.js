...
function Login() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
       const authToken= await fetch("http://localhost:5000/api/auth/login", {
            method: "POST",
            // mode: "no-cors",
            headers: {
        ...
        const AuthToken=await authToken.json();
        ...
        <div className="card container my-5">
            ...
            <form onSubmit={handleSubmit}>
                <div className="field">
                    ...
                    <input autoComplete="off" id="logemail" placeholder="Email" className="input-field" name="email" value={credentials.email} type="email" onChange={onChange}/>
                </div>
                <div className="field">
                    <svg className="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
                        <path d="M80 192V144C80 64.47 144.5 0 224 0C303.5 0 368 64.47 368 144V192H384C419.3 192 448 220.7 448 256V448C448 483.3 419.3 512 384 512H64C28.65 512 0 483.3 0 448V256C0 220.7 28.65 192 64 192H80zM144 192H304V144C304 99.82 268.2 64 224 64C179.8 64 144 99.82 144 144V192z"></path></svg>
                    <input autoComplete="off" id="logpass" placeholder="Password" className="input-field" name="pwd" value={credentials.pwd} type="password" onChange={onChange} />
                </div>
